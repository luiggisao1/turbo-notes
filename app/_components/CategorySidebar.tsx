    ...
    <aside className="fixed left-0 top-[90px] h-[calc(100vh-90px)] w-72 bg-background px-6 py-8 flex-shrink-0 flex flex-col justify-between">
      <div>
        <h2
          ...
          className="text-lg inter-bold mb-6 cursor-pointer"
        >
          All Categories
        </h2>
        <div className="space-y-2 w-64">
          {categories.map((category) => {
            const colorClass =
              CATEGORY_COLORS[category.key as keyof typeof CATEGORY_COLORS] ||
              "bg-card";
            ...
            return (
              ...
              >
                <div
                  className={`w-3 h-3 rounded-full ${colorClass} mr-3 flex-shrink-0`}
                />
